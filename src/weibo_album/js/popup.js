...
var Wbpd = Wbpd || {};
Wbpd.prototype = {
    options_url: "weibo_album/option.html",
    ...
    uploadFinishEvent: function () {
        $('#uploadPlaceHolder').prop('src', 'img/1x1.png');
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result && result.code == '100000') {
                    ...
                    }).text("没登录微博，点击此处登录账号后再刷新页面上传").show()
                }
            },
            error: function () {
                $("div.loading-bar").remove();
        ...
        for (var i = 0; i < n; i++) {
            str = str + '\
                        <div class="col-xs-4 col-md-4 col-lg-4">\
                            ...
                            <img src="img/placeholder2.png" class="clicker dragger batch-img" id="pic' + i + '">\
                            <div class="progress">\
    ...
    getImageFile: function (img_file, flag) {
        ...
        if (img_file.length > 0 && ($('.clicker:first').attr('src') != 'placeholder.png' || $('.clicker:last').attr('src') != 'img/placeholder2.png')) {
            Wbpd.prototype.clearData();
        }
    ...
    previewAndUpload: function (file, i) {
        ...
        reader.onload = function (e) {
            if (Wbpd.prototype.is_batch != 1) {
                $('.single-model img').prop('src', 'img/1x1.png');
    ...
    clearData: function () {
        ...
        //清空批量模式中的数据
        $('.batch-model').html('<div><img src="img/placeholder2.png" class="dragger clicker"></div>');
